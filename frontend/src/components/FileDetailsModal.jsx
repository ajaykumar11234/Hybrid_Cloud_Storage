...
export default function FileDetailsModal({
  selectedFile,
  setSelectedFile, // Make sure this prop is received
  analyzeFile,
  analyzingFiles,
  previewFile,
  downloadFile,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <ModalContent
          ...
          setSelectedFile={setSelectedFile} // Add this line
...
// Update ModalContent to include setSelectedFile in props
const ModalContent = ({
  selectedFile,
  ...
  <div className="p-6 space-y-6">
    ...
    <ActionButtons
      selectedFile={selectedFile}
      deleteFile={deleteFile}
      setSelectedFile={setSelectedFile} // Pass it down
    />
  </div>
);
...
const AIAnalysisContent = ({ selectedFile }) => {
  ...
  if (selectedFile.ai_analysis_status === 'pending') {
    return (
  ...
  if (selectedFile.ai_analysis_status === 'failed') {
    return (
      <div className="text-center py-4">
